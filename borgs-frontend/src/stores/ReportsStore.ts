...
export default class ReportsStore {
	...
	getMonthlyData() {
        ...
        axiosRequest.get(`/reports_monthly_balance/${this.virtualAccount}/${this.year}/`)
	...
	getTableData() {
        ...
        axiosRequest.get(`/reports_accounts_balance/${this.userStore.uid}`)
