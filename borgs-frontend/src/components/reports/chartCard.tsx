    ...
    <Accordion>
        ...
        <AccordionDetails>
            ...
            display: 'block', width: 1100
                ...
                <br></br> 
                The change in balance of the account throughout <strong>{reportsStore.year}</strong> is: {formatCurrencyText(reportsStore.totalAccountBalance)}
                <br></br>
            </div>
        </AccordionDetails>
  </Accordion>
...
export function catChartAccordion(reportsStore, accountsStore) {
    return (
    <Accordion>
        <AccordionSummary
            expandIcon={<ExpandMoreIcon />}
            ...
            id="panel1a-header"
            >
            <Typography>Categories Chart</Typography>
        </AccordionSummary>
